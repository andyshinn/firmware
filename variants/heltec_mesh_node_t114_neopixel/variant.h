...
#define NEOPIXEL_INDICATOR_DATA_PIN NEOPIXEL_DATA      // GPIO pin for NeoPixel data (SDA pin)
#define NEOPIXEL_INDICATOR_COUNT NEOPIXEL_COUNT        // Number of LEDs in the strip/chain
